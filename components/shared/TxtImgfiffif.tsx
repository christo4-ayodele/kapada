...
const TxtImgfiffif: React.FC<Props> = ({ text, imgUrl }) => {
  return (
    <div className="relative flex flex-col sm:flex-row justify-between border-lima-600 border-2 gap-7 rounded-3xl w-auto ">
      ...
      <Image
        ...
        height={400}
        width={400}
        className="h-full w-[50%] max-sm:w-full max-h-[500px] lg:min-h-[500px] object-cover rounded-3xl "
      />
    </div>
  );
};
